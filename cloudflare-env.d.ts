/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: c65beb846099d6ba7215a8c7aa34eccc)
// Runtime types generated with workerd@1.20251118.0 2025-08-15 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./.open-next/worker");
	}
	interface Env {
		NEXTJS_EN: "development" | "production";
		NEXTJS_ENV: string;
