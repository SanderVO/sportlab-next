/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 4e052096fe3a1e69681d530af7eb2b83)
// Runtime types generated with workerd@1.20260811.1 2026-07-08 enable_nodejs_process_v2,global_fetch_strictly_public,nodejs_compat,nodejs_compat_populate_process_env
interface __BaseEnv_CloudflareEnv {
	...
	WORKER_SELF_REFERENCE: Fetcher /* sportlab */ | Fetcher /* sportlab-preview */;
}
declare namespace Cloudflare {
	interface ProductionEnv {
		...
		CRON_SECRET: string;
		NEXT_CACHE_DO_QUEUE: DurableObjectNamespace /* DOQueueHandler */;
		WORKER_SELF_REFERENCE: Fetcher /* sportlab */;
	}
	interface PreviewEnv {
		...
		CRON_SECRET: string;
		NEXT_CACHE_DO_QUEUE: DurableObjectNamespace /* DOQueueHandler */;
		WORKER_SELF_REFERENCE: Fetcher /* sportlab-preview */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOW_INDEXING" | "NEXTJS_ENV" | "PAYLOAD_SECRET" | "NEXT_PUBLIC_GTM_ID" | "NEXT_PUBLIC_SERVER_URL" | "NEXT_PUBLIC_TURNSTILE_SITE_KEY" | "PREVIEW_SECRET" | "R2_BUCKET" | "R2_PUBLIC_URL" | "R2_ENDPOINT" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_IMAGES_PREFIX" | "R2_DOCUMENTS_PREFIX" | "SMTP_FROM_ADDRESS" | "SMTP_FROM_NAME" | "SMTP_ENABLED" | "SMTP_HOST" | "SMTP_USER" | "SMTP_PASS" | "CRON_SECRET">> {}
}
